...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HRINTERVIEW_LIST actions', async () => {
    ...
    it('dispatches FETCH_HRINTERVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HRINTERVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HRINTERVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HRINTERVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HRINTERVIEW actions', async () => {
      const expectedActions = [
        {
