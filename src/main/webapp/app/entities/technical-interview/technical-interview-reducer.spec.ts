...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './technical-interview.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TECHNICALINTERVIEW_LIST actions', async () => {
    ...
    it('dispatches FETCH_TECHNICALINTERVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TECHNICALINTERVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TECHNICALINTERVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TECHNICALINTERVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TECHNICALINTERVIEW actions', async () => {
      const expectedActions = [
        {
