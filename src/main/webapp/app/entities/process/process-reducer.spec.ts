...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './process.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROCESS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROCESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROCESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROCESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROCESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROCESS actions', async () => {
      const expectedActions = [
        {
