...
export const CandidateDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="iKaMetApp.candidate.delete.question">
        <Translate contentKey="iKaMetApp.candidate.delete.question" interpolate={{ id: candidateEntity.id }}>
