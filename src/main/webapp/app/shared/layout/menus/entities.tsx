...
export const EntitiesMenu = props => (
  ...
  >
    ...
    <MenuItem icon="asterisk" to="/hr-interview">
      <Translate contentKey="global.menu.entities.hrInterview" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/technical-interview">
      <Translate contentKey="global.menu.entities.technicalInterview" />
    </MenuItem>
